...
`version --json` reports the bridge capability list plus the active backend (`active_backend`) and its declared `adapter_capabilities`; prefer those fields over prose assumptions when choosing backend-dependent flows.
