...
| `question_answer_ms` | integer | `300000` | How long `requestUserInput` waits for a response before rejecting the unanswered server request. CLI override: `--question-timeout-ms`. |
