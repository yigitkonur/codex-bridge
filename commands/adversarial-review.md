...
```bash
node "${CLAUDE_PLUGIN_ROOT}/skill/scripts/codex-bridge.mjs" adversarial-review "$ARGUMENTS"
```
...
```typescript
Bash({
  command: `node "${CLAUDE_PLUGIN_ROOT}/skill/scripts/codex-bridge.mjs" adversarial-review "$ARGUMENTS"`,
