...
- `plugin/.claude-plugin/plugin.json` declares plugin-local relative surfaces for skills, commands, and explicit agent files; Claude Code auto-discovers the standard `plugin/hooks/hooks.json`.
...
- `package.json`, root marketplace/plugin metadata, `plugin/.claude-plugin/plugin.json`, `skill/SKILL.md`, and `plugin/skills/codex-bridge/SKILL.md` use canonical `codex-bridge`/`2.0.0` release identity.
