...
| PLUG-02 | PASS | Metadata tests and baseline checks pin the explicit relationship: package/root plugin/legacy skill/packaged skill use `2.0.0`, while packaged plugin metadata stays `2.0.0-alpha.0` under noncanonical marketplace entry `codex-bridge-v2-alpha`. |
